...
3. That's it! Now you can click on the button that appears on the top right left of the page. (Recently i've realised, that `shadowRoot` api in chrome ain't that stable, so better experience is achieved in firefox or some another browsers, not based on chromium)
